({
	...
	handlePillsEvent: function(component, event, helper) {
		helper.parsePillsToField(component);
		helper.parseFieldToPills(component);
	},
	...
	onRemovePill: function(component, event, helper) {
		...
		var pills 			= component.get("v.pills");//component.get("v.delimiter");
		var currentInput 	= component.get("v.searchField");
		var sResult 		='';
