...
({
    doInit: function(component, event, helper) {
		console.log('Start of CSFilterd.doInit...');
        ...
        if(search){
	        ...
	        action.setCallback(this, function(response) {
	            ...
	            if (state === "SUCCESS") {
	                ...
	                resultsLoad.dataFilter(attrFields,attrObjects,attrCondition,attrFilter);
	            }
	            else if (state === "ERROR") {
    ...
    //     helper.setFormFilter(component,changeValue);
    // },
