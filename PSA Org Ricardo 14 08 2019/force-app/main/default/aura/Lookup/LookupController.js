({
	...
	getRecords : function( component, event, helper ){
		...
		component.set( "v.fieldAsLabel", attributes.fieldAsLabel );
		component.set( "v.whereSearch", attributes.whereSearch );
		component.set( "v.objectAPIName", attributes.objectAPIName );
		component.set( "v.fromCMPMethod", true );
		component.set( "v.disabled", attributes.disabled );

		helper.searchHelper( component, event, '', attributes.whereSearch );
	}
})